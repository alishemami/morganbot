...
FUTURES_SYMBOLS = [
    ...
    'LINKUSDT', 'LTCUSDT', 'BCHUSDT', 'ALGOUSDT', 'ATOMUSDT', 'NEARUSDT', 'TRXUSDT', 'MATICUSDT',
    'DOTUSDT', 'UNIUSDT', 'ICPUSDT', 'XLMUSDT', 'ETCUSDT', 'THETAUSDT', 'VETUSDT', 'FILUSDT',
    'SANDUSDT', 'MANAUSDT', 'GALAUSDT', 'AAVEUSDT', 'CAKEUSDT', 'CRVUSDT', 'MKRUSDT', 'SNXUSDT',
    'COMPUSDT', 'YFIUSDT', 'SUSHIUSDT', '1INCHUSDT', 'ENJUSDT', 'ZILUSDT', 'QTUMUSDT', 'BATUSDT',
    'ZRXUSDT', 'KSMUSDT', 'DASHUSDT', 'NEOUSDT', 'WAVESUSDT', 'OMGUSDT', 'KAVAUSDT', 'CHZUSDT',
    'ANKRUSDT', 'IOSTUSDT', 'SKLUSDT'
]
